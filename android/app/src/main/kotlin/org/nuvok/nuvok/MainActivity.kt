...
class MainActivity : FlutterActivity() {
    ...
    override fun configureFlutterEngine(flutterEngine: FlutterEngine) {
        ...
        // UDP multicast (Nuvok Mesh) requires a MulticastLock on Android;
        // without it most devices silently drop multicast datagrams.
        MethodChannel(flutterEngine.dartExecutor.binaryMessenger, "nuvok/multicast")
                    ...
                    "acquire" -> {
                        try {
                            if (multicastLock == null) {
                                ...
                                multicastLock = wifi.createMulticastLock("nuvok-link").apply {
        ...
        MethodChannel(flutterEngine.dartExecutor.binaryMessenger, "nuvok/sensors")
            .setMethodCallHandler { call, result ->
                when (call.method) {
        ...
        MethodChannel(flutterEngine.dartExecutor.binaryMessenger, "nuvok/sos_alarm")
            .setMethodCallHandler { call, result ->
                when (call.method) {
        ...
        EventChannel(flutterEngine.dartExecutor.binaryMessenger, "nuvok/ble_mesh/events")
        ...
        EventChannel(flutterEngine.dartExecutor.binaryMessenger, "nuvok/sensors/compass")
