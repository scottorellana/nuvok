...
Future<void> main() async {
  ...
  await extractPmTiles(
    source: HttpRangeSource(Uri.parse('https://build.protomaps.com/20260708.pmtiles')),
    dest: dest,
  ...
  sw.stop();
  print('tiempo: ${sw.elapsed.inSeconds}s, tamaño: ${(dest.lengthSync()/1048576).toStringAsFixed(1)} MB');
  ...
  print('tile Belmopan z12: ${t.bytes().length} bytes → VISOR OK');
  await a.close();
}
